function criarForm(var_decisao, restricoes) {
	...
	if (var_decisao > 0 && restricoes > 0) {
		...
		document.getElementById("target").innerHTML+="<input type='number' class='inputZ' required autocomplete='off' size='5' maxlength='10' step='0.1' id='y1' name='y1' />x<sub>1</sub>";
		for (var h = 2; h <= var_decisao; h++) {
			document.getElementById("target").innerHTML+=" + <input type='number' class='inputZ' required autocomplete='off' size='5' maxlength='10' step='0.1' id='y"+h+"' name='y"+h+"' />x<sub>"+h+"</sub>";
		}
		for (var i = 1; i <= restricoes; i++) {
			document.getElementById("target").innerHTML+="<p><b>Restrição "+i+"</b></p>";
			document.getElementById("target").innerHTML+="<input type='number' class='input' required autocomplete='off' size='5' maxlength='10' step='0.1' id='x"+i+"1' name='x"+i+"1' />x<sub>1</sub>";
			for (var j = 2; j <= var_decisao; j++) {
				document.getElementById("target").innerHTML+=" + <input type='number' class='input' required autocomplete='off' size='5' maxlength='10' step='0.1' id='x"+i+j+"' name='x"+i+j+"' />x<sub>"+j+"</sub>";
			}
